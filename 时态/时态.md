...
※It is the+最高级/序数词+名词+（that）+带现在完成时谓语的句子<br/>It is the best movie that i've ever seen。<br/>It is **the first time** (that) I've ever performed a surgery
...
```have attempted
For years researchs _____________  (attempt) to show that television is dangerous for children.
```

```have been trying
Since the time humankind started gardening,we _____________  (try) to make out environment more beautiful.
```
