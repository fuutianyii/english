...
**Seeing in the cat**, the mouse ran off
...
当上述感官动词或使役动词变为卫东语态时，需还原不定式符号to：
...
let the work **be done** immediately<br/>
让工作立即完成吧(等待去完成)
...
```mermaid
graph LR
A["have/make"] ==> do["do 让....做"]
A["have/make"] ==> done["done 让....被做"]
```
